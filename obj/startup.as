	...
	; Compiler options:
	;
	; -oFCCS-DBoard-test.cof -mFCCS-DBoard-test.map --summary=default \
	; --output=default delay.p1 handle_rs485.p1 input.p1 interrupt.p1 \
	; led.p1 main.p1 output.p1 timer.p1 uart.p1 --chip=16F1946 \
	; -ID:\Program Files (x86)\Microchip\xc8\v1.30\include \
	; -ID:\BYT-WORK\BYT-MCU\byt-fccs-vtest\inc -P --runtime=default \
...
;Stack space: 0204Eh-02127h (218 bytes)
...
;	VCAPEN = OFF, VCAP pin functionality is disabled
